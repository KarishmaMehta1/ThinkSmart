            ...
            <div id="body">
                <div id="content">
                    <div id="vquestion">
                        ...
                        <hr>
                        <div id="comments">
                            <div id="sugs"><a href="./viewQuestionSuggestions.php?post_id=<?php echo $post_id; ?>">View User Suggestions</a></div>
                            <div style="clear:both;margin-bottom: 4px;"></div>
                            <?php
                                $getComments = $link -> prepare("SELECT * FROM comments WHERE post_id = $post_id ORDER BY datetime DESC;");
                                $getComments -> execute();
                            ...
                            <div id="cmntbox">
                                <a class="authname">
                                    <?php
                                        $getCmntAuthor = $link -> prepare("SELECT expert_name FROM experts WHERE expert_username = '$ecmnt[user_username]';");
                                        $getCmntAuthor -> execute();
                                        $resultCmntAuthor = $getCmntAuthor -> fetch(PDO::FETCH_ASSOC);
                                        echo $resultCmntAuthor['expert_name'];
                                    ?>
                                </a> said:<br>
                                <?php
                                    print "$ecmnt[comment]";
