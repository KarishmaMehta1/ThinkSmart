...
<body>
    <pre>
        ...
        $saveLogEntry = $link -> prepare("INSERT INTO activity_log(ip, username, location, browser, window, file) VALUES ('$_SERVER[REMOTE_ADDR]','$_SESSION[username]','$userLoc','$ua[name].$ua[version]','$win[0]','$_SERVER[REQUEST_URI]');");
        $saveLogEntry -> execute();
        ?>
    </pre>
</body>
</html>