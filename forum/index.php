            ...
            <div id="body">
                <div id="content">
                    <?php
                        ...
                        $getQuestions = $link -> prepare("SELECT * FROM forum_posts WHERE solutions = 0 ORDER BY datetime DESC LIMIT 15;");
                    ...
                    <div class="question">
                        ...
                        <div class="details">
                            ...
                            <div class="authcat">
                                <div class="category">
                                    <a href="./viewCatQuestions.php?cat_id=<?php print $row['cat_id']; ?>">
                                    <?php
